	...
	<liferay-ui:icon-menu direction="down" extended="<%= false %>" icon="<%= StringPool.BLANK %>" message="<%= StringPool.BLANK %>" showWhenSingleIcon="<%= true %>" triggerCssClass="btn">
		...
		<c:if test="<%= JournalArticlePermission.contains(permissionChecker, article, ActionKeys.VIEW) %>">
			...
			<portlet:resourceURL var="asposeIconResourceURL">
	            <portlet:param name="struts_action" value="/journal/aspose_icon_action" />
	        </portlet:resourceURL>
	  
 			<portlet:resourceURL var="exportDocResourceURL">
	            <portlet:param name="struts_action" value="/journal/aspose_export_doc" />
	            <portlet:param name="groupId" value="<%= String.valueOf(article.getGroupId()) %>" />
				<portlet:param name="articleId" value="<%= article.getArticleId() %>" />
				<portlet:param name="version" value="<%= String.valueOf(article.getVersion()) %>" />
	        </portlet:resourceURL>
	        ...
	        <portlet:resourceURL var="exportPdfResourceURL">
	            <portlet:param name="struts_action" value="/journal/aspose_export_pdf" />
	            <portlet:param name="groupId" value="<%= String.valueOf(article.getGroupId()) %>" />
				<portlet:param name="articleId" value="<%= article.getArticleId() %>" />
				<portlet:param name="version" value="<%= String.valueOf(article.getVersion()) %>" />
	        </portlet:resourceURL>
	        ...
	        <portlet:resourceURL var="exportXlsResourceURL">
	            <portlet:param name="struts_action" value="/journal/aspose_export_xls" />
	            <portlet:param name="groupId" value="<%= String.valueOf(article.getGroupId()) %>" />
				<portlet:param name="articleId" value="<%= article.getArticleId() %>" />
				<portlet:param name="version" value="<%= String.valueOf(article.getVersion()) %>" />
	        </portlet:resourceURL>
				...
				/>
				<liferay-ui:icon
					src="<%= asposeIconResourceURL.toString() %>"
					message='<%= LanguageUtil.get(pageContext, "aspose-export-doc") %>'
					url="<%= exportDocResourceURL.toString() %>"
				/>
					<liferay-ui:icon
					src="<%= asposeIconResourceURL.toString() %>"
					message='<%= LanguageUtil.get(pageContext, "aspose-export-pdf") %>'
					url="<%= exportPdfResourceURL.toString() %>"
				/>
					<liferay-ui:icon
					src="<%= asposeIconResourceURL.toString() %>"
					message='<%= LanguageUtil.get(pageContext, "aspose-export-xls") %>'
